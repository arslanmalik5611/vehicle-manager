...
function consumption_load() {
    $.ajax({
        url: api_url + 'consumption/'+consumption_id,
        dataType: "JSON",
...
function create_item_row(item_data) {
    ...
    if (item_data.id) {
        consumption_detail_id = item_data.id;
    }
    var newRow = `<tr class="item-row" consumption-detail-id="${consumption_detail_id}">
...
$("#form-data").on('submit', function (e) {
    ...
    e.preventDefault();
    $.ajax({
        url: api_url + "consumption/update",
        type: "POST",
...
function getFormData() {
    ...
    $('.item-row').each(function () {
        var item_row = {
            'consumption_detail_id': $(this).attr('consumption-detail-id'),
