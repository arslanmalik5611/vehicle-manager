    ...
    <style>
        ...
        * {
        ...
        .profile_img {
            ...
            overflow: hidden;
            background-size: cover;
            background-image: url({{$data->user->user_picture_url}});
        ...
        <div class="subpage">
            ...
            <div class="profile_detail">
                ...
                <div class="user_detail">
                    <table>
                        <tr>
                            <td class="detail_name">Joining Date</td>
                            <td class="detail_value"> : {{$data->joining_date_formatted}}</td>
                        </tr>
                        <tr>
                            <td class="detail_name">Designation</td>
                            <td class="detail_value"> : {{$data->designation}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                <div style="font-size: 2px">{!! QrCode::size(100)->generate("$data->personal_number") !!}</div>
    ...
    <div class="back_page">
        <div class="subpage">
            ...
            <div class="footer">
                ...
                <div class="date">
                    <p>Session : <span class="joined">{{$data->session->name}}</span></p>
