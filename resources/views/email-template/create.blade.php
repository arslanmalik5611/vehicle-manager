...
<div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <div>
                <h2 class="text-info"><i class="fas fa-plus-circle fa-icon"></i>Email Template Create </h2>
            </div>
            <div>
                <a href="{{env('BASE_URL').'email-template'}}" class="btn btn-outline-success btn-sm">Email Template List</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        <form method="post" id="form-data">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control tinymce-custom" id="body" name="body" placeholder="Enter Body"></textarea>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form-data").on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                url: api_url + "email-template/store",
                type: "POST",
                data: $(this).serialize(),
                dataType: "JSON",
