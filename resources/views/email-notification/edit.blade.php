...
<div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <div>
                <h2 class="text-info"><i class="fas fa-edit fa-icon"></i>Email Template Edit </h2>
            </div>
            <div>
                <a href="{{env('BASE_URL').'email-template'}}" class="btn btn-outline-success btn-sm">Email Tempalte
                    List</a>
            </div>
        </div>
    </div>
        ...
        <form method="post" id="form-data">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control tinymce" id="body" name="body" placeholder="Enter Body"></textarea>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        email_template_load_data();
    });

    function email_template_load_data() {
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.data.body)
                    tinyMCE.get('body').setContent(response.data.body);
            }
        });
    }
    ...
    $("#form-data").on('submit', function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: api_url + "email-template/update",
            type: "POST",
            data: $(this).serialize(),
            dataType: "JSON",
