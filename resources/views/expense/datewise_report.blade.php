    ...
    <div id="main_centerBody">
        <table id="tbl">
            ...
            <tr style="background-color:#7fffd4;color:#000000;">
                ...
                <td style="width: 250px;">Expense Head</td>
            ...
            if (empty($expense)) {
                ...
                $GrandTotal = 0;
                foreach ($expense as $exp_value) {
                    $totalprice = $serielNumber = 0;
                    ?>
                    <tr>
                        <td colspan="8"
                            style="text-align: left !important; background-color:darkorange;">Date: <b><?php echo date($exp_value[0]['expense_date_formatted']); ?></b></td>
                    </tr>
                    <?php
                    foreach ($exp_value as $exp) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $exp['expense_date_formatted']; ?></td>
                            <td><?php echo $exp['expense_head']['name']; ?></td>
                            <td><?php echo $exp['notes']; ?></td>
                            <td><?php echo $exp['user_session']['user']['first_name']; ?></td>
                            <td><?php echo $exp['created_user']['first_name']; ?></td>
                            <td><?php echo $exp['amount']+0; ?></td>
                            <?php echo "<td style='color:red' class='remove' exp_id=$id>Delete</td>"; ?>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <tr>
                    ...
                    <td class="totalprice" colspan="2"><?php echo $GrandTotal+0; ?>/-</td>
                </tr>
                <?php
            }
...
<script type="text/javascript">
    ...
    $(document).on('click', '.remove', function () {
        ...
        if (r == true) {
            ...
            alert(api_url+`expenses/${exp_id}/delete`)
            thisRow = $(this);
            $.ajax({
                type: "POST",
                url: api_url+`expenses/${exp_id}/delete`,
                // data: {"exp_id": exp_id},
                dataType: "JSON",
