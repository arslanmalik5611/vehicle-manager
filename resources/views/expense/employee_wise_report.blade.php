        ...
        <table id="tbl">
            ...
            if (empty($expense)) {
                ...
                foreach ($expense as $exp_value) {
                    ...
                    <tr>
                        <td colspan="8"
                            style="text-align: left !important; background-color:darkorange;"><?php echo $exp_value[0]['user_session']['user']['first_name'] . ' ' . $exp_value[0]['user_session']['user']['last_name'] ?></td>
                    </tr>
                    <?php
