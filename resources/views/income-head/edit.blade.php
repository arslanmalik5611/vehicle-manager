...
@section('page_title','Income Head Edit')
    ...
    <div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{env('BASE_URL').'income-heads'}}" class="btn btn-outline-success btn-sm">Income Head
                        List</a>
                </div>
            </div>
        </div>
...
@section('page_level_scripts')
    <script type="text/javascript">
      ...
      $(document).ready(function () {
          $.ajax({
              url: api_url + `income-heads/${id}/show`,
              dataType: "JSON",
        ...
        $("#form-data").on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: api_url + "income-heads/update",
                type: "POST",
                data: $(this).serialize(),
                dataType: "JSON",
