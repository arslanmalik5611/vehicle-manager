...
<script src="{{asset('panel_assets/js/custom.js?v='.date('ymdhis'))}}"></script>
<script src="{{asset('panel_assets/js/custom-2.js?v='.date('ymdhis'))}}"></script>
<script src="{{asset('panel_assets/js/time_line.js')}}"></script>

<script type="text/javascript">
    var view_name = '@php echo $view_name; @endphp';
    var base_web_url = "@php  echo env('BASE_URL') @endphp";
</script>
<script src="{{asset('panel_assets/js/footer.js?v='.date('ymdhis'))}}"></script>
<script type="text/javascript">
