        ...
        <table id="tbl">
            ...
            if (empty($income)) {
                ...
                foreach ($income as $income_value) {
                    ...
                    <tr>
                        <td colspan="8"
                            style="text-align: left !important; background-color:darkorange;"><?php echo $income_value[0]['user_session']['user']['first_name'] . ' ' . $income_value[0]['user_session']['user']['last_name'] ?></td>
                    </tr>
                    <?php
                    foreach ($income_value as $in) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $in['user_session']['user']['first_name']; ?></td>
                            <td><?php echo $in['created_user']['first_name']; ?></td>
