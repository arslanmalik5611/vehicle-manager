                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <table class="table table-striped table-bordered table-hover table-responsive" id="">
                            ...
                            <tr>
                                <th>Add</th>
                                <th style="width: 200px">Income</th>
                            ...
                            <tr class="expenseRow">
                                ...
                                <td>
                                    <select name="income_head_id[]" class="form-control income_head_id"></select>
                                </td>
                                <td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#addMoreBtn', function (e) {
            ...
            var mainTr = `<tr class="expenseRow">
                                ...
                                <td>
                                    <select name="income_head_id[]" class="form-control income_head_id">
