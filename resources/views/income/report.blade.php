    ...
    <div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{env('BASE_URL').'incomes'}}" class="btn btn-outline-success btn-sm">Income
                        List</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form method="get" id="form-data" action="{{env('BASE_URL').'incomes/income-report'}}" target="_blank">
                <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label for="expense_head_id" class="form-label"><span class="required"></span> Income Heads </label>
                        <select name="expense_head_id" class="form-control income_head_id select2"></select>
                    </div>
