        ...
        <div class="row">
            <div class="col-md-6 col-lg-5 left-col mb-5 mb-md-0">
                <div class="left-col-content">
                    ...
                    <form action="#" class="sign-in-form" id="reset_form">
                        <div class="mb-4">
                            <label for="password" class="form-label mb-3 default-label">New Password</label>
                            <input type="password" class="form-control rounded-pill default-input" name="password"
                                   id="password"
                                   placeholder="e.g. Atleast 6 characters">
                        </div>
                        <div class="mb-4">
                            <label for="password" class="form-label mb-3 default-label">Confirm Password</label>
                            <input type="password" class="form-control rounded-pill default-input" name="cpassword"
                                   id="password"
                                   placeholder="e.g. Atleast 6 characters">
                        </div>

                        <input type="hidden" value="<?php echo $reset_code; ?>" name="reset_code">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                               value="<?= $this->security->get_csrf_hash(); ?>">
                        <button type="submit" class="btn default-btn mb-4 w-100 reset-btn">Save Password <i
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#reset_form").on('submit', function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: base_url + "register/reset_password",
                type: "POST",
                data: $(this).serialize(),
                dataType: "JSON",
