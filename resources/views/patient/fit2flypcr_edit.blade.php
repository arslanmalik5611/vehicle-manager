...
@section('page_title','FIT 2 FLY PCR EDIT')
    ...
    <div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div>
                    <h2 class="text-info"><i class="fas fa-edit fa-icon"></i> Edit Fit to Fly PCR Patient</h2>
                </div>
                <div>
            ...
            function patient_load() {
                $.ajax({
                    ...
                    success: function (response) {
                        var inputs = ['first_name', 'last_name', 'gender', 'country_id', 'state', 'city', 'postal_code', 'address', 'phone_no', 'email', 'passport_number', 'destination_country_id', 'transport_mode', 'station_from', 'travel_time'];
                        var dates = ['dob', 'travel_date'];
                        ...
                        setTimeout(function(){
                            ...
                            $('#destination_country_id').val(response.data.destination_country_id).change();
                        },1000);
                    }
                });
            }
