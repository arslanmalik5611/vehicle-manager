...
@section('page_title','Pending Reports Patients List')
    ...
    <div class="card text-dark shadow-2 mb-3" style="max-width: 18rem;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div>
                    <h2 class="text-info"><i class="fas fa-clipboard-list fa-icon"></i> Pending Reports Patients List
                    </h2>
                </div>
                <div>
        ...
        <div class="card-body table-responsive">
            ...
            <form action="{{env('BASE_URL').'patients/report-create'}}">
                <div class="row mb-3">
                    <div class="col-md-10">
...
2201600019
 etc."></textarea>
                    ...
                    <div class="col-md-2">
                        <br/><br/><br/>
                        <input type="submit" class="btn btn-primary" value="Create Report(s)">
                    </div>
                </div><!--End of row-->
            </form>
...
@section('page_level_scripts')
    ...
    <script src="{{asset('panel_assets/js/patient_pending_report_list.js?v='.date('ymdhis'))}}"></script>
@endsection
